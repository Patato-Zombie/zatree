    ...
    <body style="text-align:center;" >
        ...
        <form method="get" style="font-size:8px;text-align:left;padding-left:10px;" id="searchForm" >
            ...
            排序：<select id="order_key" name="order_key" onchange="changeOrderType();" >
                ...
                <option value="lastvalue" <?php if ($orderkey == 'lastvalue') {
            echo 'selected="selected"';
        }; ?>>最新</option>
                <option value="max" <?php if ($orderkey == 'max') {
            echo 'selected="selected"';
        }; ?>>最大</option>
                <option value="min" <?php if ($orderkey == 'min') {
            echo 'selected="selected"';
        }; ?>>最小</option>
            ...
            <select id="order_type" name="order_type">
                <option value=''>默认</option>
                <option value="asc" <?php if ($ordertype == 'asc') {
            echo 'selected="selected"';
        }; ?>>升序</option>
                <option value="desc" <?php if ($ordertype == 'desc') {
            echo 'selected="selected"';
        }; ?>>降序</option>
            </select>
